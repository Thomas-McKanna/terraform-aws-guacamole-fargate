...
| [aws_s3_bucket.nlb_logging](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket) | resource |
| [aws_s3_bucket_policy.nlb_logging_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/s3_bucket_policy) | resource |
...
| <a name="input_enable_nlb_logging"></a> [enable\_nlb\_logging](#input\_enable\_nlb\_logging) | Whether to enable logging for the NLB. | `bool` | `false` | no |
...
| <a name="output_nlb_logging_bucket"></a> [nlb\_logging\_bucket](#output\_nlb\_logging\_bucket) | Name of S3 bucket which stores NLB logs (requires setting enable\_nlb\_logging to true) |
